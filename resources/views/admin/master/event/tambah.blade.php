...
@section('content')
    <form action="{{ route('admin.event-pernikahan.tambah') }}" method="post">
        ...
        <div class="w-1/2 mx-auto">
            ...
            <div class="w-full mb-4">
                <div class="w-full">
                    <div class="w-full p-2 text-xs font-bold bg-pink @error('jenis') bg-red-400 @enderror text-white flex items-center justify-start rounded-t">
                        Jenis
                    </div>
                    <select class="w-full p-2 flex-1 border-x-2 border-b-2 text-sm @error('jenis') border-red-400 @enderror rounded-b focus:border-pink focus:outline-none"
            ...
            <div class="w-full mb-4">
                <div class="w-full">
                    <div class="w-full p-2 text-xs font-bold bg-pink @error('keterangan') bg-red-400 @enderror text-white flex items-center justify-start rounded-t">
                        Keterangan
                    </div>
