    ...
    <form action="{{ route('admin.event-pernikahan.tambah') }}" method="post">
        ...
        <div class="w-[50%]">
            <div class="w-full">
                ...
                <div class="w-100 mb-4">
                    <div class="w-100">
                        <div class="w-100 p-2 text-xs font-bold bg-pink @error('jenis') bg-red-500 @enderror text-white flex items-center justify-start rounded-t">
                            Jenis
                        </div>
                ...
                <div class="w-100 mb-4">
                    <div class="w-100">
                        ...
                        <textarea class="w-full p-2 flex-1 border-x-2 border-b-2 resize-none text-sm @error('keterangan') border-red-500 @enderror rounded-b focus:border-pink focus:outline-none"
                            name="keterangan" id="input" rows="3" placeholder="masukkan keterangan event ini"
