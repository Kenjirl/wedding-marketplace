...
@section('content')
    {{-- FORM GANTI PASSWORD --}}
    <div class="w-[50%] p-4">
        <form class="m-0" action="{{ route('admin.profil.ubah_password') }}" method="post">
            @csrf
            {{-- PASSWORD --}}
            ...
            <div class="w-100 flex items-center justify-end gap-4">
                ...
                <button class="w-fit px-4 py-2 text-white font-semibold bg-pink hover:bg-pink-hover focus:bg-pink-hover active:bg-pink-active focus:outline-pink-hover focus:outline-offset-2 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors rounded"
