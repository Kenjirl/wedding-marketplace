...
@section('h1', 'Kategori Pernikahan > Ubah')

@section('content')
    <form action="{{ route('admin.kategori-pernikahan.ubah', $wkg->id) }}" method="post">
        @csrf
        <div class="w-[50%]">
            <div class="w-full">
                {{-- KATEGORI --}}
                <div class="w-100 mb-4">
                    <div class="w-100">
                        ...
                        <input class="w-full p-2 flex-1 border-x-2 border-b-2 text-sm @error('kategori') border-red-500 @enderror rounded-b focus:border-pink focus:outline-none"
                            ...
                            value="{{ old('kategori', $wkg->kategori) }}"
                            required>
                    </div>
                ...
                <div class="w-100 mb-4">
                    <div class="w-100">
                        ...
                        <input class="w-full p-2 flex-1 border-x-2 border-b-2 text-sm @error('keterangan') border-red-500 @enderror rounded-b focus:border-pink focus:outline-none"
                            ...
                            value="{{ old('keterangan', $wkg->keterangan) }}"
                            required>
                    </div>
                ...
                <div>
                    Terakhir diubah oleh : {{ $wkg->admin->nama }}
                </div>
            </div>
