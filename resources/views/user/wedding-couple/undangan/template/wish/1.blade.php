...
<div class="relative w-full">
    ...
    <div class="w-full">
        <div class="w-full py-8 px-4 md:px-10 lg:px-20 max-w-[90%] lg:max-w-[75%] mx-auto shadow-lg sdiv
            ...
            <form action="{{ $wedding->invitation ? route('wedding-couple.tamu.rsvp', $tamu->id) : '#' }}" method="POST">
                @csrf
        ...
        <div class="w-full py-8 px-4 md:px-10 lg:px-20 max-w-[90%] lg:max-w-[75%] mx-auto shadow-lg sdiv
            ...
            <form action="{{ $wedding->invitation ? route('wedding-couple.tamu.wish', $tamu->id) : '#' }}" method="POST">
                @csrf
