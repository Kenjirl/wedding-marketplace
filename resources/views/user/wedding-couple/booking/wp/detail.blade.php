...
@section('content')
    <div class="relative w-full p-8 flex items-start justify-center gap-4">
        ...
        <div class="sticky top-8 w-1/3 mx-auto">
            ...
            <div class="w-full">
                ...
                <div class="w-full p-2 text-sm">
                    ...
                    @if ($photographer->status == 'Individu')
                        <div class="w-full mb-2"> {{-- Gender --}}
                            <div class="w-full flex items-center justify-start gap-2">
                                <i class="fa-solid fa-venus-mars text-pink"></i>
                                <p>Gender</p>
                            </div>
                            <div class="w-full px-6">
                                {{ $photographer->gender }}
        ...
        <div class="w-full">
            ...
            <div class="w-ful mx-auto mb-8 flex items-start justify-start gap-8">
                {{-- container kanan --}}
