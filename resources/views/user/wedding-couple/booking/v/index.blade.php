...
@section('title')
    <title>Cari Venue | Wedding Marketplace</title>
@endsection
    ...
    <div class="w-full max-w-[1200px] mx-auto p-4">
        ...
        <div class="fixed top-0 -right-[400px] w-[400px] bg-white border-l-2 border-pink z-10 transition-all"
            ...
            <div class="relative w-full min-h-screen mt-20 p-4">
                ...
                {{-- FILTER FORM --}}
                <form action="{{ route('wedding-couple.search.v.index') }}" method="get">
                    @csrf
        ...
        <div class="w-full p-8 grid grid-cols-4 gap-8">
            @forelse ($filteredVenues as $venue)
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full p-2">
                            ...
                            <div class="my-2">
                                <p>
                                    {{
                                        'Rp ' . $venue->harga_terendah .
                                        ' ~ ' .
                                        'Rp ' . $venue->harga_tertinggi
                                    }}
                                </p>
                            </div>
                            ...
                            <div class="w-full">
                                <p class="text-sm">
                                    ...
                                    {{ $venue->rate > 0 ? number_format($venue->rate, 1, ',') : '-' }}/5
                                    @if ($venue->bookedCount > 0)
                                        | {{ $venue->bookedCount }} dipesan
                                    @endif
                                </p>
                            </div>
                        </div>
