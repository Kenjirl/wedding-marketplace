                        ...
                        <table>
                            <tbody class="text-sm">
                                <tr> {{-- Owner --}}
                                    ...
                                    <td class="align-top">Pemilik</td>
                                    <td class="align-top">:</td>
                                    <td class="align-top">{{ $organizer->nama_pemilik }}</td>
                                </tr>
                                <tr> {{-- PT --}}
                                ...
                                <tr> {{-- Basis Operasi --}}
                                    ...
                                    <td class="align-top">:</td>
                                    <td class="align-top">{{ $organizer->basis_operasi }}</td>
                                </tr>
                                @if ($organizer->basis_operasi == 'Hanya di Dalam Kota')
                                    <tr> {{-- Kota Operasi --}}
                                        ...
                                        <td class="align-top">:</td>
                                        <td class="align-top">{{ $organizer->kota_operasi }}</td>
                                    </tr>
                                @endif
                                <tr> {{-- Kategori --}}
                                    <td class="text-center align-top"><i class="fa-solid fa-hashtag"></i></td>
