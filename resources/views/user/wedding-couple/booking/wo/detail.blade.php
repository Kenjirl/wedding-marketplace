                ...
                <div class="w-full p-2 text-sm">
                    ...
                    <div class="w-full mt-8">
                        <div class="w-full flex items-center justify-center gap-2 mb-2">
                            @for ($i = 1; $i <= 5; $i++)
                                <i class="fa-solid fa-star {{ $organizer->rate >= $i ? 'text-pink' : '' }}"></i>
                            @endfor
                        </div>
                        <div class="w-full text-center">
                            {{ $organizer->rate > 0 ? number_format($organizer->rate, 1) : '-' }} dari 5
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-3/4">
            ...
            <div class="w-full mb-2 flex items-center justify-start gap-4">
                ...
                {{ $tab == 'layanan' ? 'bg-pink text-white' : 'text-pink bg-white' }}"
                    href="{{ route('wedding-couple.search.wo.ke_detail', ['id' => $organizer->id, 'tab' => 'layanan']) }}">
                    <span>Layanan</span>
                </a>
            </div>
