                ...
                <div class="w-1/3">
                    <div class="w-full mx-auto flex items-center justify-center flex-nowrap gap-4">
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#header" data-section="header" data-tippy-content="Header" title="Header">
                            <i class="fa-solid fa-house"></i>
                        </a>
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#quote" data-section="quote" data-tippy-content="Quote" title="Quote">
                            <i class="fa-solid fa-quote-left"></i>
                        </a>
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#profile" data-section="profile" data-tippy-content="Profile" title="Profile">
                            <i class="fa-solid fa-user"></i>
                        </a>
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#event" data-section="event" data-tippy-content="Event" title="Event">
                            <i class="fa-regular fa-calendar"></i>
                        </a>
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#gallery" data-section="gallery" data-tippy-content="Gallery" title="Gallery">
                            <i class="fa-solid fa-image"></i>
                        </a>
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#wish" data-section="wish" data-tippy-content="Wish" title="Wish">
                            <i class="fa-regular fa-comment"></i>
                        </a>
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#info" data-section="info" data-tippy-content="Info" title="Info">
                            <i class="fa-solid fa-circle-info"></i>
                        </a>
                        <a class="island-section-anchor min-w-[45px] aspect-square flex items-center justify-center rounded-full outline-pink outline-offset-4 text-pink bg-white border
                            hover:bg-pink hover:text-white focus:bg-pink focus:text-white transition-colors"
                            href="#footer" data-section="footer" data-tippy-content="Footer" title="Footer">
        ...
        $(document).ready(function() {
            ...
            // INPUT QUOTE
                ...
                $('#terapkanQuoteBtn').on('click', function() {
                    ...
                    toastr.success(`Menerapkan quote`, "Sukses");
                });
            ...
            // INPUT PROFILE
                ...
                $('#terapkanFotoProfilBtn').click(function() {
                    ...
                    toastr.success(`Menerapkan foto pengantin`, "Sukses");
                });
            ...
            // INPUT GALLERY
                ...
                $('#terapkanFotoGaleriBtn').click(function() {
                    ...
                    toastr.success(`Menerapkan foto galeri`, "Sukses");
                });
