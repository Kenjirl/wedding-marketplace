...
@endphp
<div class="min-h-screen flex items-center justify-center" style="background-color: #6EACDA; color: #ffffff;"
    id="wish">
        ...
        <div class="w-full">
            <div class="w-full py-8 px-4 md:px-10 lg:px-20 max-w-[90%] lg:max-w-[75%] mx-auto sdiv
                ...
                <form action="{{ $wedding->invitation ? route('user.tamu.rsvp', $tamu->id) : '#' }}" method="POST">
                    ...
                    <button class="block w-fit px-4 py-2 mx-auto text-[.8em] md:text-base rounded font-semibold border shadow-sm"
                        ...
                        style="background-color: #6EACDA; color: #ffffff"
                        id="div"
            ...
            <div class="w-full py-8 px-2 md:p-8 lg:px-20 max-w-[90%] lg:max-w-[75%] mx-auto sdiv
                ...
                <div class="min-h-[50vh] max-h-[50vh] p-2 overflow-y-auto">
                        ...
                        @forelse ($wedding->guests as $tamu)
                            @if ($tamu->pesan != null)
                                <div class="w-full p-2 mb-4 last-of-type:mb-0 flex items-center justify-center rounded-xl shadow-md"
                                    style="background-color: #ffffff; color: #6EACDA;"
                                    id="div">
                    ...
                    @else
                        @for ($i = 0; $i < 10; $i++)
                            <div class="w-full p-2 mb-4 last-of-type:mb-0 flex items-center justify-center rounded-xl shadow-md" style="background-color: #ffffff; color: #6EACDA"
                                id="div">
