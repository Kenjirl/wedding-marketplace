...
class CtLayananController extends Controller
{
    public function index() {
        ...
        return view('user.catering.layanan.index', compact('plans'));
    }

    public function ke_tambah() {
        return view('user.catering.layanan.tambah');
    }
    ...
    public function tambah(Request $req) {
        ...
        if ($data) {
            return redirect()->route('catering.layanan.index')->with('sukses', 'Menambah Paket Layanan');
        }
        return redirect()->route('catering.layanan.index')->with('gagal', 'Menambah Paket Layanan');
    }
    ...
    public function ke_ubah($id) {
        ...
        if (!$plan) {
            return redirect()->route('catering.layanan.index')->with('gagal', 'ID Invalid');
        }

        $currentPhotos = $plan->foto ?? [];
        $count = count($currentPhotos);

        return view('user.catering.layanan.ubah', compact('plan', 'count'));
    }
    ...
    public function ubah(Request $req, $id) {
        ...
        if ($data) {
            return redirect()->route('catering.layanan.ubah', $id)->with('sukses', 'Mengubah Paket Layanan');
        }
        return redirect()->route('catering.layanan.ubah', $id)->with('gagal', 'Mengubah Paket Layanan');
    }
    ...
    public function hapus($id) {
        ...
        if ($data) {
            return redirect()->route('catering.layanan.index')->with('sukses', 'Menghapus Paket Layanan');
        }
        return redirect()->route('catering.layanan.index')->with('gagal', 'Menghapus Paket Layanan');
    }
