...
class CtPesananController extends Controller
{
    public function index() {
        ...
        return view('user.catering.pesanan.index', compact('bookings'));
    }
    ...
    public function ke_detail($id) {
        ...
        if (!$booking) {
            return redirect()->route('catering.pesanan.index')->with('gagal', 'ID Invalid');
        }
        ...
        return view('user.catering.pesanan.detail', compact(
            'booking',
            'plan',
            'wedding',
            'events',
    ...
    public function respon(Request $req, $id) {
        ...
        if ($data && $req->status == 'diterima') {
            return redirect()->route('catering.pesanan.index')->with('sukses', 'Menerima Pesanan');
        } else if ($data && $req->status == 'ditolak') {
            return redirect()->route('catering.pesanan.index')->with('sukses', 'Menolak Pesanan');
        }
        return redirect()->route('catering.pesanan.ke_detail', $id)->with('gagal', 'Terjadi kesalahan');
    }
}
