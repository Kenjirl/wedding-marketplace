...
class CtJadwalController extends Controller
{
    public function index() {
        ...
        foreach ($bookings as $booking) {
            $events[] = [
                ...
                'allDay' => true,
                'url'    => route('catering.jadwal.ke_detail', $booking->id),
                'start' => $booking->untuk_tanggal,
            ];
        }

        return view('user.catering.jadwal.index', compact('events'));
    }
    ...
    public function ke_detail($id) {
        ...
        if (!$booking) {
            return redirect()->route('catering.jadwal.index')->with('gagal', 'ID Invalid');
        }
        ...
        return view('user.catering.jadwal.detail', compact(
            'booking',
            'plan',
            'wedding',
            'events',
    ...
    public function batal(Request $req, $id) {
        ...
        if ($data) {
            return redirect()->route('catering.jadwal.index')->with('sukses', 'Membatalkan Pesanan');
        }
        return redirect()->route('catering.jadwal.ke_detail', $id)->with('gagal', 'Terjadi kesalahan');
    }
}
