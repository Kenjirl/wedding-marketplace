...
class CtPortofolioController extends Controller
{
    public function index() {
        ...
        return view('user.catering.portofolio.index', compact('latest_portofolio', 'portofolio'));
    }

    public function ke_tambah() {
        return view('user.catering.portofolio.tambah');
    }
    ...
    public function tambah(PortofolioRequest $req) {
        ...
        if ($config->value) {
            ...
            foreach ($config->value as $item) {
                if (isset($item['vendor']) && $item['vendor'] === 'catering') {
                    $wpConfig = $item;
                    break;
                }
            }
        ...
        if ($data) {
            return redirect()->route('catering.portofolio.ke_ubah', $portofolio->id)->with('sukses', 'Menambah Portofolio');
        }
        return redirect()->route('catering.portofolio.index')->with('gagal', 'Menambah Portofolio');
    }
    ...
    public function ke_ubah($id) {
        ...
        if (!$portofolio) {
            return redirect()->route('catering.portofolio.index')->with('gagal', 'Portofolio tidak ditemukan');
        }
        ...
        return view('user.catering.portofolio.ubah',
            compact(
                'portofolio',
                'provinsi',
                'kota',
    ...
    public function ubah(PortofolioRequest $req, $id) {
        ...
        if ($data) {
            return redirect()->route('catering.portofolio.ke_ubah', $id)->with('sukses', 'Mengubah Portofolio');
        }

        return redirect()->route('catering.portofolio.index')->with('gagal', 'Mengubah Portofolio');
    }
    ...
    public function hapus($id) {
        ...
        if ($data) {
            return redirect()->route('catering.portofolio.index')->with('sukses', 'Menghapus Portofolio');
        }
        return redirect()->route('catering.portofolio.index')->with('gagal', 'Menghapus Portofolio');
    }
